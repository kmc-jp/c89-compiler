...
AstRef ast_make_not_pure_pointer_abstract_declarator(AstRef pointer,
    AstRef direct_abstract_declarator) {
  AstRef self = NULL;
  if ((pointer == NULL ||
       ast_is_pointer(pointer)) &&
...
AstRef ast_make_direct_abstract_declarator(AstRef direct_abstract_declarator) {
  ...
  if (ast_is_abstract_declarator(direct_abstract_declarator) ||
      ...
      ast_is_function_type_abstract_declarator(direct_abstract_declarator)) {
...
AstRef ast_make_array_abstract_declarator(AstRef direct_abstract_declarator,
    AstRef constant_expression) {
  AstRef self = NULL;
