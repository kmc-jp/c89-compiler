...
DEFINE_AST_GET_METHOD(index_access_expression, IndexAccessExpression)
DEFINE_AST_GET_METHOD(function_call_expression, FunctionCallExpression)
DEFINE_AST_GET_METHOD(dot_access_expression, DotAccessExpression)
DEFINE_AST_GET_METHOD(arrow_access_expression, ArrowAccessExpression)
...
DEFINE_AST_GET_METHOD(unary_operator_expression, UnaryOperatorExpression)
...
DEFINE_AST_GET_METHOD(address_expression, AddressExpression)
DEFINE_AST_GET_METHOD(dereference_expression, DereferenceExpression)
...
DEFINE_AST_GET_METHOD(complement_expression, ComplementExpression)
DEFINE_AST_GET_METHOD(logical_negate_expression, LogicalNegateExpression)
DEFINE_AST_GET_METHOD(cast_or_unary_expression, CastOrUnaryExpression)
...
DEFINE_AST_GET_METHOD(multiply_expression, MultiplyExpression)
DEFINE_AST_GET_METHOD(divide_expression, DivideExpression)
DEFINE_AST_GET_METHOD(modulo_expression, ModuloExpression)
DEFINE_AST_GET_METHOD(additive_expression, AdditiveExpression)
DEFINE_AST_GET_METHOD(add_expression, AddExpression)
DEFINE_AST_GET_METHOD(subtract_expression, SubtractExpression)
...
DEFINE_AST_GET_METHOD(declaration_specifier_list, DeclarationSpecifierList)
DEFINE_AST_GET_METHOD(declaration_specifier, DeclarationSpecifier)
DEFINE_AST_GET_METHOD(init_declarator_list, InitDeclaratorList)
DEFINE_AST_GET_METHOD(init_declarator, InitDeclarator)
DEFINE_AST_GET_METHOD(declarator_with_initializer, DeclaratorWithInitializer)
...
DEFINE_AST_GET_METHOD(array_declarator, ArrayDeclarator)
DEFINE_AST_GET_METHOD(function_declarator, FunctionDeclarator)
DEFINE_AST_GET_METHOD(old_style_function_declarator, OldStyleFunctionDeclarator)
...
DEFINE_AST_GET_METHOD(variadic_parameter_list, VariadicParameterList)
DEFINE_AST_GET_METHOD(parameter_list, ParameterList)
DEFINE_AST_GET_METHOD(parameter_declaration, ParameterDeclaration)
DEFINE_AST_GET_METHOD(parameter_abstract_declaration, ParameterAbstractDeclaration)
...
DEFINE_AST_GET_METHOD(array_abstract_declarator, ArrayAbstractDeclarator)
DEFINE_AST_GET_METHOD(function_type_abstract_declarator, FunctionTypeAbstractDeclarator)
