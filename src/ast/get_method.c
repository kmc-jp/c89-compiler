...
DEFINE_AST_GET_METHOD(enumerator_with_initializer, EnumeratorWithInitializer)
...
DEFINE_AST_GET_METHOD(parameter_concrete_declaration, ParameterConcreteDeclaration)
...
DEFINE_AST_GET_METHOD(pointer_abstract_declarator, PointerAbstractDeclarator)
...
DEFINE_AST_GET_METHOD(function_abstract_declarator, FunctionAbstractDeclarator)
...
DEFINE_AST_GET_METHOD(identifier_labeled_statement, IdentifierLabeledStatement)
DEFINE_AST_GET_METHOD(case_labeled_statement, CaseLabeledStatement)
DEFINE_AST_GET_METHOD(default_labeled_statement, DefaultLabeledStatement)
...
DEFINE_AST_GET_METHOD(goto_jump_statement, GotoJumpStatement)
DEFINE_AST_GET_METHOD(continue_jump_statement, ContinueJumpStatement)
DEFINE_AST_GET_METHOD(break_jump_statement, BreakJumpStatement)
DEFINE_AST_GET_METHOD(return_jump_statement, ReturnJumpStatement)
DEFINE_AST_GET_METHOD(void_return_jump_statement, VoidReturnJumpStatement)
