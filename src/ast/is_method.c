...
DEFINE_AST_IS_METHOD(not_pure_pointer_abstract_declarator, NOT_PURE_POINTER_ABSTRACT_DECLARATOR)
...
DEFINE_AST_IS_METHOD(function_type_abstract_declarator, FUNCTION_TYPE_ABSTRACT_DECLARATOR)
