...
AstArrayDeclaratorRef ast_get_array_declarator(AstRef ast);
AstFunctionDeclaratorRef ast_get_function_declarator(AstRef ast);
AstOldStyleFunctionDeclaratorRef ast_get_old_style_function_declarator(AstRef ast);
...
AstFunctionTypeAbstractDeclaratorRef ast_get_function_type_abstract_declarator(AstRef ast);
