...
bool ast_is_declaration_specifier_list(AstRef ast);
...
bool ast_is_function_declarator(AstRef ast);
bool ast_is_old_style_function_declarator(AstRef ast);
bool ast_is_pointer(AstRef ast);
bool ast_is_type_qualifier_list(AstRef ast);
bool ast_is_parameter_type_list(AstRef ast);
bool ast_is_parameter_list_with_variable_length_argument(AstRef ast);
