...
bool ast_is_pointer_abstract_declarator(AstRef ast);
bool ast_is_direct_abstract_declarator(AstRef ast);
bool ast_is_array_abstract_declarator(AstRef ast);
bool ast_is_function_abstract_declarator(AstRef ast);
...
bool ast_is_identifier_labeled_statement(AstRef ast);
bool ast_is_case_labeled_statement(AstRef ast);
bool ast_is_default_labeled_statement(AstRef ast);
...
bool ast_is_goto_jump_statement(AstRef ast);
